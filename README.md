...
The current converter handles board outlines, components, pads, plated and non-plated holes, routed copper with vias, nets, PCB silkscreen, schematic components, ports, labels, native power ports, junctions, and traces. It also preserves multiple schematic sheets and sanitizes Altium field and filename text.
